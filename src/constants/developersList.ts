  ...
  },
  {
    ...
    message: `Tavishi has a lot of things to think about. Things like game ideas, conceptualization, design,
     development and live ops challenges. In fact, most of our ideas have taken
      ...
      `,
    profile: `Tavishi holds a CS Degree from MNNIT Allahabad and started her career as an Fullstack developer 2 years ago. She's architected msdStudio Scalable Server`,
    dp: tavishiDP,
  },
  {
    name: "Varun Bansal",
    message: `How do you prepare for an unprecedented change in disruptive technological advancements? 
    That’s the task Varun has set forth for himself.  
    he has worked on several global titles over his 5 year career span. 
    `,
    profile: `Outside of work, you will find him with his handy iPad designing the perfect images of uncommon birds.`,
  },
  {
    name: "Rahul Chandyok",
    message: `Rahul is responsible for overseeing msdStudio's global finance operations including accounting, investor relations, tax, as well as leading operations.
    `,
    profile: `With over 8 years of experience in industry, Rahul has touched nearly every area of the business.`,
    dp: rahulDP,
  },
];
