...
class DigipaperPrivacyPolicy extends React.Component {
  _scroll = () => {
  ...
  render() {
    return (
      <div className="policy-container">
        <div className="digipaper-privacy-policy">
          <strong>Privacy Policy</strong>
          <p>
            MSD Studio built the digipaper app as a Free app. This SERVICE is
            provided by MSD Studio at no cost and is intended for use as is.
          </p>
          <p>
          ...
          <p>
            ...
            our Terms and Conditions, which is accessible at digipaper unless
          ...
          <p>
            ...
            including but not limited to Camera and storage access to capture
            and save image . The information that I request will be retained on
          ...
          <p>
            ...
            not hesitate to contact me at developer@eagertools.com.
          </p>
        </div>
      </div>
    );
...
export default DigipaperPrivacyPolicy;
