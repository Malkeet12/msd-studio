...
class TimePassPrivacyPolicy extends React.Component {
  _scroll = () => {
  ...
  render() {
    return (
      <div className="policy-container">
        <div className="time-pass-privacy-policy">
          <strong>Privacy Policy</strong>{" "}
          <p>
            MSD Studio built the Time pass app as a Free app. This SERVICE is
          ...
          <p>
            ...
            our Terms and Conditions, which is accessible at Time pass unless
          ...
          <p>
            ...
            not hesitate to contact me at https://msdstudio.in.
          </p>
          {/* <p> */}
...
export default TimePassPrivacyPolicy;
